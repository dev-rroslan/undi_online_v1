defmodule UndiOnline.BillingFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `UndiOnline.Billing` context.
  """

  import UndiOnline.AccountsFixtures

  alias UndiOnline.Billing.{Product, Products, Plans, Customers, Subscriptions, Invoices}
