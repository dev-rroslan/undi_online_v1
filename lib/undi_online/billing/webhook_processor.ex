defmodule UndiOnline.Billing.WebhookProcessor do
  @moduledoc """
  """
  use GenServer
  ...
  alias UndiOnline.Billing.HandleSubscriptions
  alias UndiOnline.Billing.HandleInvoices
  alias UndiOnline.Billing.HandlePaymentMethods
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(UndiOnline.PubSub, "webhook_processed")
  end

  def notify_subscribers(event) do
    Phoenix.PubSub.broadcast(UndiOnline.PubSub, "webhook_processed", {:event, event})
  end
