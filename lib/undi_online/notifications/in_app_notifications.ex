defmodule UndiOnline.InAppNotifications do
  @moduledoc """
  ...
  alias UndiOnline.InAppNotifications.Notification
  ...
  defp notify_subscribers({:ok, notification} = result) do
    Phoenix.PubSub.broadcast(UndiOnline.PubSub, "notification:#{notification.user_id}", %{notification: notification})
    result
  end
  ...
  def subscribe_on_notification_created(user_id) do
    Phoenix.PubSub.subscribe(UndiOnline.PubSub, "notification:#{user_id}")
  end
end
