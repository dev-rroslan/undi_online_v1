defmodule UndiOnline.Accounts.Account do
  ...
  schema "accounts" do
    ...
    has_many :users, UndiOnline.Accounts.User
    has_one :billing_customer, UndiOnline.Billing.Customer
  ...
  def registration_changeset(account, attrs) do
    ...
    |> cast_assoc(:users, with: {UndiOnline.Accounts.User, :registration_changeset, []})
    |> set_token(account)
  end
