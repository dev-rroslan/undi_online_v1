defmodule UndiOnline.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :notifications, UndiOnline.InAppNotifications.Notification
  ...
  defp validate_unique_email(changeset) do
    UndiOnline.Repo.put_skip_account_id(true)
    changeset = unsafe_validate_unique(changeset, :email, UndiOnline.Repo)

    UndiOnline.Repo.put_skip_account_id(false)
    changeset
  end
