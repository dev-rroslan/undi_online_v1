defmodule UndiOnlineWeb.Admin.SessionController do
  use UndiOnlineWeb, :controller

  import UndiOnline.Admins.GenerateAdmin
  alias UndiOnline.{Admins, Admins.Guardian}

  plug UndiOnlineWeb.Plugs.RedirectAdmin when action in [:new, :create]
