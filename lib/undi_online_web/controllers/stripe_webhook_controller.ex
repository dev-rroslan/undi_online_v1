defmodule UndiOnlineWeb.StripeWebhookController do
  ...
  def notify_subscribers(event) do
    Phoenix.PubSub.broadcast(UndiOnline.PubSub, "webhook_received", %{event: event})
  end

  def subscribe_on_webhook_recieved do
    Phoenix.PubSub.subscribe(UndiOnline.PubSub, "webhook_received")
  end
