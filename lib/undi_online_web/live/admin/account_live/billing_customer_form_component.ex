defmodule UndiOnlineWeb.Admin.AccountLive.BillingCustomerFormComponent do
  ...
  def handle_event("save", %{"stripe_customer" => %{"email" => email} = params}, socket) do
    ...
    |> case do
      %Ecto.Changeset{valid?: true} ->
        ...
        UndiOnline.Billing.CreateStripeCustomer.create_customer_in_stripe(%{account: account, email: email})
